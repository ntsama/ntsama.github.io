...
J’ai le plaisir d’annoncer que ma proposition de bourse postdoctorale MSCA, **« Cognitive Trapeze »**, a été entièrement validée par mon équipe de supervision à l’Université de Copenhague (UCPH) et par le bureau de soutien à la recherche de l'UCPH.

La proposition finale (Partie A, Partie B-1 et Partie B-2) a été examinée et approuvée. Elle sera officiellement soumise sur le **portail EU Funding & Tenders** avant la date limite du 9 septembre 2026, marquant l’aboutissement de plus d’un an de préparation, de développement de preuves de concept techniques et de collaboration internationale.

Le projet est soutenu par une solide équipe d’encadrement :
- **Superviseur principal :** Professeur Daniel Spikol (UCPH, Danemark)
- **Co‑superviseur et hôte du secondement :** Professeur Marcelo Worsley (Université Northwestern, États‑Unis)
- **Supervision terrain :** Délégation Régionale du MINESEC (Adamaoua) et ses ICR
- **Conseiller académique :** Professeur Pius Ondoua (Université de Yaoundé I, Cameroun)

Avec une contribution européenne totale de **283 502 €** et une durée de 24 mois, le projet vise à formaliser le modèle du Trapèze Cognitif et à développer un tuteur de lecture IA 100 % hors ligne pour les zones d'éducation prioritaire au Cameroun. Je suis dans l’attente du résultat du processus d’évaluation.
...
Pourtant, une réponse concrète est déjà en marche. **Dr Jean Marie Ntsama**, fondateur du programme **IA4ZEP** et enseignant au sein du lycée, a conçu et testé une **fiche de leçon digitalisée** pour une classe de 6ème en français. Cette leçon intègre une **vidéo animée par IA** illustrant le conte *« L’intelligence, l’aînée de la force »*.

👉 **Visionnez la vidéo utilisée pour cette leçon ici :** [L'intelligence, l'aînée de la force](https://youtu.be/-bAZBe6-mtw?feature=shared)

Cette expérience démontre que la **Pédagogie Augmentée par IA** n'est pas un luxe réservé aux établissements privilégiés, mais un outil accessible qui peut :
- **Motiver les apprenants** grâce à des contenus multimodaux engageants.
- **Réduire la dépendance aux matériaux physiques coûteux**, un problème récurrent souligné par le rapport JPOE.
- **Soutenir les enseignants** en fournissant des cadres pédagogiques structurés et prêts à l'emploi.

IA4ZEP confirme ainsi sa mission : allier la rigueur scientifique aux réalités du terrain, pour construire un pont Afrique–Europe en matière d'éducation numérique. Des travaux ont également été engagés sur des modules de Génie Civil pour digitaliser la formation technique.

---

### **Activités à venir**
- **Génie Civil :** Développement de tutoriels assistés par IA pour la maçonnerie et le béton armé.
- **Formation des enseignants :** Atelier sur l'utilisation des outils d'IA pour la préparation des cours et l'évaluation.
...
### **Juin 2026 — Finalisation de la page MSCA**  
Le projet MSCA *Cognitive Trapeze* est présenté de manière claire, structurée et bilingue.

---

# 🧠 Activités à venir  

### Cognitive Trapeze — Développement scientifique  
Préparation de :  
- la modélisation conceptuelle  
- la collecte de données multilingues  
- les expériences cognitives  
- la conception de la simulation computationnelle  

### IA_4_ZEP — Actions éducatives  
Travaux prévus :  
- ateliers de littératie numérique  
- activités d’apprentissage assistées par IA  
- modules de formation pour enseignants  

---

# 📚 Publications — Nouvelles entrées bientôt  
De nouveaux manuscrits en préparation seront ajoutés à la page Publications.

---

# 🗂 Archive  
Une archive chronologique sera ajoutée au fur et à mesure de l’évolution du projet.
