...
- Renforcer l’expertise en modélisation cognitive  
...
- Profil fortement interdisciplinaire  

### 2. Impact sur l’Institution d’Accueil  
- Nouvelles collaborations  
- Innovation méthodologique  
- Recherche Europe–Afrique  

### 3. Impact sur l’Europe  
- Contribution à l’éducation numérique  
- Cadres d’IA éthique  
- Innovation en sciences cognitives  

### 4. Impact sur l’Afrique  
- Littératies numériques multilingues  
- Apprentissages inclusifs  
...
Collecte de données, tâches multilingues, profils neurodivergents.  

**WP3 — Modélisation computationnelle**  
Simulation multi‑agents des dynamiques langage–pensée.  

**WP4 — Diffusion & Impact**  
Publications, ateliers, jeux de données ouverts, initiatives Afrique–Europe.  
...
### 3. Risques & Solutions  
- Recrutement faible → élargir les profils et les réseaux de recrutement  
- Complexité de la modélisation → prototypes successifs et itératifs  
- Variabilité des données → triangulation méthodologique (quantitative + qualitative)  
...
## Adéquation avec l’Institution d’Accueil & Plan de Formation  
L’institution d’accueil offre :  
- une expertise en sciences cognitives et IA  
- un environnement interdisciplinaire  
- un accès aux infrastructures de modélisation computationnelle  
- une intégration dans des réseaux de recherche européens  
